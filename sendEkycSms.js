  ...
  const payload = JSON.stringify({
    ...
    "raw": {
      ...
      "application": {
        ...
        "customDopa": "ktaxa",
        "customAmlo": "",
        "emailContent": "กรุณายืนยันตัวตนผ่านลิงก์ ${application.verificationBasePath}/${id}",
        "smsContent": "belloooo3 กรุณายืนยันตัวตนผ่านลิงก์ ${application.verificationBasePath}/${id}",
        ...
        "webhookUrl": "https://portal-dev.mac-non-prod.appmanteam.com/api/v2/case-keeper/verifications/webhook",
        "watermarkUrl": null,
        "verificationBasePath": "https://portal-dev.mac-non-prod.appmanteam.com/apps/identity-verification",
